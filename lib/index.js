...
const jsxA11y = [jsxA11yPlugin.flatConfigs.recommended];
const testingLibrary = [testingLibraryPlugin.configs['flat/react']];
const promise = [
    promisePlugin.configs['flat/recommended'],
    {
        rules: promiseRules,
...
const eslintPlugin = [eslintP.configs['flat/recommended']];
